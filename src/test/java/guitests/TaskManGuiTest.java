...
/**
 * A GUI Test class for TaskDiary.
 */
public abstract class TaskManGuiTest {
     ...
     */
    protected TaskDiary getInitialData() {
        TaskDiary ab = TestUtil.generateEmptyTaskDiary();
        TypicalTestTasks.loadTaskDiaryWithSampleData(ab);
        return ab;
    }
