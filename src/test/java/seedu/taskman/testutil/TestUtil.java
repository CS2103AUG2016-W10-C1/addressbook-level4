...
public class TestUtil {
    ...
    public static void createDataFileWithSampleData(String filePath) {
        createDataFileWithData(generateSampleStorageTaskDiary(), filePath);
    }
    ...
    public static TaskDiary generateEmptyTaskDiary() {
        return new TaskDiary(new UniqueTaskList(), new UniqueTagList());
    }

    public static XmlSerializableTaskDiary generateSampleStorageTaskDiary() {
        return new XmlSerializableTaskDiary(generateEmptyTaskDiary());
    }
