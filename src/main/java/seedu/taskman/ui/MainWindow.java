...
public class MainWindow extends UiPart {
    ...
    public static MainWindow load(Stage primaryStage, Config config, UserPrefs prefs, Logic logic) {
        ...
        mainWindow.configure(config.getAppTitle(), config.getTaskDiaryName(), config, prefs, logic);
        return mainWindow;
    }

    private void configure(String appTitle, String taskDiaryName, Config config, UserPrefs prefs,
                           Logic logic) {
    ...
    void fillInnerParts() {
        ...
        statusBarFooter = StatusBarFooter.load(primaryStage, getStatusbarPlaceholder(), config.getTaskDiaryFilePath());
